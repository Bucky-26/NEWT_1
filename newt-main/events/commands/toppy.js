...
module.exports = {
	config: {
		name: "toppy",
		usePrefix: true,
		description: "Ai powered by toppy Language model",
	...
	run: async function ({ api, event, args, commandModules }) {
		...
		try {
			const response = await axios.get(`https://ai.easy-api.repl.co//api/toppy?query=${encodeURIComponent(question)}&api=https://newtai.bgfxd.repl.co`);
