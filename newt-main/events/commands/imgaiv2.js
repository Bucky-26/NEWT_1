...
const text = args.join(" ");
    try {
      const response = await axios.get(`https://sensui-useless-apis.codersensui.repl.co/api/tools/genimg?prompt=${text}`);
      const imageUrl = response.data.result; // Assuming the result contains the image URL
